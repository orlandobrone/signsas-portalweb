<?php
	...
	$sql5 = " SELECT acpm,valor_transporte,toes
			  	  FROM  `items_anticipo` 
			      WHERE  estado = 1 AND id_anticipo = ".(int)$_GET['ide_per'];
	...
	$total_anticipo ='$'.number_format($total + str_replace($letters,"",$giro[0])).',00';
...
$mensaje .=  ' <h4>Lista Item</h4>   
			   ...
			   <table style="width:100%;table-layout: fixed;word-wrap: break-word;" border="1">
						   ...
						   <tr>
							 ...
							 <td style="font-weight:bold;width:60px; word-wrap:break-word;">Valor. ACPM</td> 
							 
							 <td style="font-weight:bold;width:60px; word-wrap:break-word;">Gal. ACPM</td> 
							 
							 <td style="font-weight:bold;width:70px; word-wrap:break-word;">Retenci&oacute;n<br/>ACPM</td> 

							 <td style="font-weight:bold;width:75px; word-wrap:break-word;">Total ACPM</td> 

							 <td style="font-weight:bold;width:75px; word-wrap:break-word;">Valor Transporte - Trasiego o Mular</td>

							 <td style="font-weight:bold;width:75px; word-wrap:break-word;">Valor Viaticos - TOES</td>
					 ...
					 if($total > 0):
						   ...
						   $mensaje .= '<tr>
										  ...
										  <td style="width:230px; word-wrap:break-word;">'.utf8_encode($row['nombre']).'</td>
										  
										  <td>$'.$row['valor_galon'].'</td>
