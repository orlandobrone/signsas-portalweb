      ...
      <table style="display:block">      
            ...
            <tr>             
                ...
                <td>
                    ...
                    <? $sqlPry = "SELECT * FROM linea_negocio ORDER BY codigo DESC"; 
                    ...
                    <select name="cedula_consignar" id="cedula_consignar" class="chosen-select required">
                        ...
                        <? while ($rsPry = mysql_fetch_array($qrPry)) { ?>
                            ...
                            <option value="<?=$rsPry['identificacion']?>" 
                                ...
                                tipocuenta="<?=$rsPry['tipo_cuenta']?>"
                                
                                <?=($rs_per['cedula_consignar'] == $rsPry['identificacion'])?'selected="selected"':''?>><?=$rsPry['identificacion']?></option>
        ...
        <tbody>          	
            ...
            <tr>
              ...
              <td>
                  ...
                  <input type="text" name="total_anticipo" id="total_anticipo" readonly value="<?=$total_anticipo?>"/>               
        ...
        <tbody>       
           ...
           <tr class="defecto">                  
                  ...
                  <td colspan="3">
                  	  ...
                  	  Galones<input type="text" name="galones" id="galones" value="0" alt="integer" class="required valor_total_galon" style="width:110px"/>
                      
                      V. Gal&oacute;n<input type="text" name="valor_galon" id="valor_galon" value="0" alt="decimal" class="required valor_total_galon" style="width:110px"/>
                      
					  Total
                      <input type="text" name="acpm" id="acpm" value="0" alt="decimal" class="required" style="width:120px" readonly />               
...
$(document).ready(function () {
            ...
            var source = {
				...
				cache: false,
			    url: 'ajax_list_items.php?id=<?=$_POST['ide_per']?>&prioridad=<?=$rs_per['prioridad']?>',
				root: 'Rows',
				sortcolumn: 'i.id',
                sortdirection: 'desc',
				filter: function(){
...
$(document).ready(function(){
		...
		//$('#orden_trabajo').change(function(){ 
			...
			$.getJSON('ajax_list_hitos_orden.php', {id_proyecto:<?=$rs_per['id_ordentrabajo']?>}, function (data) { 
