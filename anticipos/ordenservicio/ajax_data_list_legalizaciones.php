<? header('Content-type: text/html; charset=iso-8859-1');
	...
	$query = "SELECT SQL_CALC_FOUND_ROWS * FROM legalizacion WHERE id_anticipo = ".$_GET['idanticipo']." AND estado != 'ELIMINADO' LIMIT $start, $pagesize";
...

		{
...

		    {
...

				{
					...
					$where .= ") id_anticipo = ".$_GET['idanticipo']." AND estado != 'ELIMINADO' ";
...

		{
...

			{
...

				{
					...
					$query = "SELECT * FROM legalizacion ORDER BY" . " " . $sortfield . " AND  id_anticipo = ".$_GET['idanticipo']." AND estado != 'ELIMINADO' DESC LIMIT $start, $pagesize";
...

				{
					...
					$query = "SELECT * FROM legalizacion ORDER BY" . " " . $sortfield . " AND  id_anticipo = ".$_GET['idanticipo']." AND estado != 'ELIMINADO'  ASC LIMIT $start, $pagesize";
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		...
		$resultado_anticipo = mysql_query("SELECT * FROM anticipo WHERE estado != 4 AND id_legalizacion =".$row['id']) or die(mysql_error());
