...
$mensaje = '
	...
	<table width="700" border="1" >
        	 ...
        	 <tr>
			 	...
			 	<td style="font-weight:bold;" align=center colspan="2">ORDEN DE SERVICIO PARA CONTRATISTA <br> 
    ...
    andrea.rojas@signsas.com-asistente.compras@ts-sas.com</td>
                ...
                <td align=center colspan="2"><img src="http://operacionsign.com/logo_sign.png"  style="float:left;"/></td>
   ...
   <br/>
	...
	<table width="700" border="1">
	 	<tr>
	  	...
	  	<tr>
			<td width="33" style="font-weight:bold;">ID HITO</td>
			<td width="115" style="font-weight:bold;">HITO</td>
			<td width="77" style="font-weight:bold;">p_o/TIKET</td>
			<td width="100" style="font-weight:bold;">DESCRIPCI&Oacute;N</td>
			<td width="50" style="font-weight:bold;">FORMA PAGO</td>
			<td width="41" style="font-weight:bold;">CANT</td>
			<td width="82" style="font-weight:bold;">VR. UNITARIO</td>
			<td width="80" style="font-weight:bold;">VR. TOTAL</td>
  		</tr>';
		...
		if($total > 0):
			...
			while($row = mysql_fetch_assoc($resultado)):
				...
				$mensaje .= '<tr>
							  <td style="width:33px; word-wrap:break-word;">'.$row['id_hitos'].'</td>
							  
							  <td style="width:175px; word-wrap:break-word;font-size:10px;">'.$row['nombre_hito'].'</td>
							  
							  <td>'.$row['po_ticket'].'</td>
							  <td style="width:110px; word-wrap:break-word; font-size:10px;">'.$row['descripcion_os'].'</td> 
							  <td style="width:50px; word-wrap:break-word;">'.$row['forma_pago'].'</td>
							  <td>'.$row['cantidad'].'</td>
...
//$mensaje .= '</table>';
	  ...
	  $result = mysql_query("SELECT SUM(total) as total 
	  						 FROM items_ordenservicio 
							 WHERE estado IN(0,2) AND id_ordenservicio = ".$_GET['ide_per']."");	
	  ...
	  $mensaje .= ' 
		...
		<table  border="1">
		  <tr>
			<td colspan="3" width="753">NOTA: <br/><br/></td>
		  </tr>
		  <tr>
