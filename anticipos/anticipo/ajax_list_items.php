<?php
	...
	$query = "	SELECT SQL_CALC_FOUND_ROWS *, i.id AS ID, h.estado AS estado_hito 
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		...
		$totalAnticipo = $transporte + $toes + $acpm + $viaticos + $mular;
		
		//sin impuestos
		$transporte =  str_replace($letters, $fruit,$row['valor_transporte']);
		$toes =  str_replace($letters, $fruit,$row['toes']);
		$acpm =  str_replace($letters, $fruit,$row['acpm']);
		$viaticos =  str_replace($letters, $fruit,$row['viaticos']);
		$mular =  str_replace($letters, $fruit,$row['mular']);		
		$total_hitos = $acpm + $transporte + $toes + $viaticos + $mular;
		...
		$customers[] = array( 
			...
			'total_hito'=>$total_hitos ,//sin impuesto
