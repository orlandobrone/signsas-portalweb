        ...
        $(document).ready(function () {            
...

            {
                ...
                columns: [
				  ...
				  { text: 'Beneficiario', datafield: 'id_beneficiario', filtertype: 'textbox', filtercondition: 'starts_with'}, 
			...
			/*setTimeout(function(){
				...
				swal({
				  ...
				  text: "Por el momento no se podra vincular anticipos a las legalizaciones", 
				  type: "warning",
    	...
    	<div id="cuerpo">
            ...
            <div style="background:#ECECEC; margin-bottom:15px;border:1px solid #CCC;padding:10px;margin-top:5px;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px; width:96%; margin-top:20px;">
                ...
                <!-- <input value="Agregar Anticipo" type="button" onClick="javascript: fn_mostrar_frm_agregar();" class="btn_table" />-->
                 ...
                 <input name="fecini" type="text" id="fecini" size="20" readonly />
                 ...
                 <label>Hasta: </label>   
                 <input name="fecfin" type="text" id="fecfin" size="20" readonly />
            ...
            <div id="div_oculto" style="display: none;"></div>
             ...
             <p align="left">Módulo Legalización Ver. 1.2.0</p>
