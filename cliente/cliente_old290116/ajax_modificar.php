<?
	...
	$sql = sprintf("UPDATE cliente SET natural_juridico='%s', nombre='%s', descripcion='%s', persona_contacto='%s', telefono='%s', celular='%s', email='%s', suministro=%s, servicios=%s, otros_servicios=%s, dias_vencimiento_pago=%s where id=%d;",
