<?
	...
	if(empty($_POST['id_ingreso']) || empty($_POST['hitos']) || empty($_POST['cantidad']) || empty($_POST['costo']) ){
	...
	$sql = sprintf("INSERT INTO `ingreso_mercancia` (id,id_ingreso,id_material,id_proyecto,id_hito,cantidad,costo,iva,orden_compra,fecha,parent) VALUES (null, %d, %d, %d, %d, %d, '%s', '%s', '%s', now(), 0);",
