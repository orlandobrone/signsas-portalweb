<? header('Content-type: text/html; charset=iso-8859-1');
	...
	$query = "SELECT SQL_CALC_FOUND_ROWS * FROM ingreso_mercancia WHERE id_ingreso = ".$_REQUEST['id_parent']." AND parent = 0 LIMIT $start, $pagesize";
...

		{
...

		    {
...

				{
					...
					$where .= ") AND id_ingreso = ".$_REQUEST['id_parent']." AND parent = 0 ".$materiales;
...

		{
...

			{
...

				{
					...
					$query = "SELECT * FROM ingreso_mercancia WHERE id_ingreso = ".$_REQUEST['id_parent']." AND parent = 0 ORDER BY" . " " . $sortfield . " DESC LIMIT $start, $pagesize";
...

				{
					...
					$query = "SELECT * FROM ingreso_mercancia WHERE id_ingreso = ".$_REQUEST['id_parent']." AND parent = 0 ORDER BY" . " " . $sortfield . " ASC LIMIT $start, $pagesize";
