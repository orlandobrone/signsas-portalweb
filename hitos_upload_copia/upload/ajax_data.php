<? header('Content-type: text/html; charset=iso-8859-1');
	...
	$query = "SELECT SQL_CALC_FOUND_ROWS * FROM hitos_upload LIMIT $start, $pagesize";
...

	{
...

		{
			...
			$query = "SELECT * FROM hitos_upload ".$where;
			...
			$query = "SELECT * FROM hitos_upload
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		$customers[] = array(
			...
			'acciones' => '<a href="javascript: fn_eliminar('.$row['idvalor'].');"><img src="../extras/ico/delete.png" /></a>'
		);
	}
