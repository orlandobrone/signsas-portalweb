...
<h1>Formato de Ingreso de Mercanc&iacute;a</h1>
...
$(document).ready(function () {
            ...
            $("#jqxgrid2").jqxGrid({
                ...
                columns: [
                  ...
                  { text: 'Item', datafield: 'id', filtertype: 'textbox', filtercondition: 'equal',  columntype: 'textbox'},
				  
				  { text: 'Id Material', datafield: 'id_material', filtertype: 'textbox', filtercondition: 'equal',  columntype: 'textbox'},

                  { text: 'Nombre Material', datafield: 'nombre_material',  filtertype: 'textbox', filtercondition: 'starts_with' },
