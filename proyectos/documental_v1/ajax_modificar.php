<?
	...
	$sql = sprintf("UPDATE documental SET codigo_sitio='%s', nombre_sitio='%s', actividad='%s', cliente='%s', ot_tickets='%s', hito_id='%s', nombre_documentador='%s' ,fecha_ejecucion_editable='%s' WHERE id=%d;",
