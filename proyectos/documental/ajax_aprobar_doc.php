<?
	...
	$cuerpo = '
		<p>Se aprobo el documento con los siguiente datos:</p>
		<table border="1">
			<tr>
				<td>Fecha Creado</td>
				<td>'.$rs_per['fecha_creacion'].'</td>
	...
	$mail->AddAddress('nancy.malagon@signsas.com,callcenter@signsas.com,ingsistemas.ordonez@gmail.com');	
