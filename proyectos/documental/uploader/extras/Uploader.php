    ...
    function __construct($uploadName = null) {
        ...
        if (isset($_FILES[$this->uploadName])) {
            ...
            if ($_FILES[$this->uploadName]['error'] === UPLOAD_ERR_OK) {
                $this->fileName = str_replace($healthy, $yummy,$_FILES[$this->uploadName]['name']);
        ...
        if ($this->fileName) {
            ...
            $this->fileName = str_replace(array(' ','/','\\','%20','ñ'),'_',$this->fileName);
        }
    }

    public function getFileName() {
        return str_replace(array(' ','/','\\','%20'),'_',$this->fileName);
    }
