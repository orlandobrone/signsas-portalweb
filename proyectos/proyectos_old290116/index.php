        ...
        $(document).ready(function () {
...

            {
                 ...
                 datafields: [
					 ...
					 { name: 'lugar_ejecucion', type: 'string'},
					 ...
					 { name: 'fecha_final_real', type: 'date'},

					 { name: 'id_cotizacion', type: 'string'},
...

            {
                ...
                columns: [
				  ...
				  { text: 'Nombre', datafield: 'nombre', filtertype: 'textbox', filtercondition: 'starts_with', width: 90 },
				  ...
				  { text: 'Lugar Ejecución', datafield: 'lugar_ejecucion', filtertype: 'textbox', filtercondition: 'starts_with' , width: 80  },
				  ...
				  { text: 'Fecha Final Real', datafield: 'fecha_final_real', filtertype: 'date', filtercondition: 'equal', width: 100, cellsformat: 'yyyy-MM-dd' },

				  { text: 'Cotización', datafield: 'id_cotizacion', filtertype: 'none',  cellsalign: 'left', width: 80 },
