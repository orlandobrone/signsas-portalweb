<? header('Content-type: text/html; charset=iso-8859-1');
	...
	$sql_sum ="SELECT SUM( `valor_facturado` ) AS total FROM `hitos_upload` WHERE 1 ";
	$result_sum = mysql_query($sql_sum) or die("SQL Error 5: " . mysql_error());
	$row_sum = mysql_fetch_array($result_sum, MYSQL_ASSOC);
	$total = $row_sum['total'];

	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		
		$eliminar = '';
		if(in_array(371,$_SESSION['permisos'])):
