    ...
    <table class="formulario">
        ...
        <tbody>
            ...
            <tr>
                ...
                <? 
					$qrRegional = mysql_query("SELECT id FROM regional ORDER BY `region` DESC ") or die(mysql_error()); 
					$arrayRegional = explode(',',$rs_per['id_regional']);
					$arrayCheck = array();
					while ($rowsRegional = mysql_fetch_array($qrRegional)):
						if(in_array($rowsRegional['id'], $arrayRegional)):
                ...
                <td>
                      <!--<select name="id_regional" id="id_regional" style="display:none;">
                          <option value="0" <?=($rs_per['id_regional'] == 0)? 'selected="selected"':''; ?>>Todos</option>
...
-->                    
                    ...
                    <input name="id_regional" id="id_regional"  type="hidden"/>
                    <div style="float: left;" id="jqxWidget"></div>
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td colspan="2">
					<? if(in_array(122,$_SESSION['permisos'])): ?>
