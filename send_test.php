...
echo base_base2base('m4gdalena', 36, 10, 10);
...
$mail->Host = 'gator3032.hostgator.com'; // <- el host es local porque utilizo servidor smtp del hosting
$mail->SMTPDebug  = 2; 
 
$mail->From 	  = 'jordonezb@signsas.com'; 
$mail->SMTPAuth   = true;                  // enable SMTP authentication
$mail->Host       = "gator3032.hostgator.com"; // sets the SMTP server
$mail->Port       = 465;                    // set the SMTP port for the GMAIL server
$mail->Username   = "jordonezb@signsas.com"; // SMTP account username
$mail->Password   = "pau2320245";        // SMTP account password
  
$mail->FromName = 'Dedicado';
$mail->Subject = 'Test Hosting Dedicado';
$mail->IsHTML(true); 
...
$mail->Username = "jordonez@ingecall.com";
$mail->Password = "pau2320245";


$mail->SetFrom('name@yourdomain.com', 'Notificaci&oacute;n');
