...
<table>
        ...
        <tbody>
          ...
          <tr>
		   ...
		   <tr> 
                ...
                <td>'.$rsPry['codigo'].' - '.$rsPry['nombre'].'</td>            
   ...
   $mensaje .=  '<br/><table style="width:98%;table-layout: fixed; font-size:11px;" border="1">
						   ...
						   <tr>
							 ...
							 <th style="width: 70px;" align="center">Presupuesto</th>
							 
							 <th style="width: 40px;">Cant. <br/>Soli</th>
							 <th style="width: 40px;">Cant. <br/>Invent</th>
							 <th style="width: 63px;">Costo Unitario Inventario</th>
							 <th style="width: 28px;" align="center">IVA</th>
							 <th style="width: 28px;" align="center">OC</th>
							 
							 <th style="width: 50px;">Cant. <br/>Comprada</th>
							 <th style="width: 65px;">Costo Unidad Comprada</th>
							 
							 <th style="width: 55px;">Cant. Ent. Inventario</th>
							 <th style="width: 55px;">Cant. Entregada</th>							 
					 ...
					 if($total > 0):
						   ...
						   while($row = mysql_fetch_assoc($resultado)):
							...
							$mensaje .= '<tr>
										  ...
										  <td align="center" valign="top">$'.$row['presupuesto'].'</td>  	
	...
	$mensaje .= '<table style="margin-top:20px;">
					<tr>
						<td>----------------------------------------------</td>
						<td>----------------------------------------------</td>
					</tr>
