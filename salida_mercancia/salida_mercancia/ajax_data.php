<? header('Content-type: text/html; charset=iso-8859-1');
	...
	// get data and store in a json array
 	...
 	if(in_array(161,$_SESSION['permisos']))
		$whereA = " estado NOT IN('draft') ";
	else
		$whereA = " estado NOT IN('draft','ELIMINADO') ";
	...
	$query = "SELECT SQL_CALC_FOUND_ROWS * FROM solicitud_despacho WHERE ".$whereA." LIMIT $start, $pagesize";
...

		{
...

			{
...

				{
					...
					$query = "SELECT * FROM solicitud_despacho WHERE ".$whereA." ORDER BY" . " " . $sortfield . " DESC LIMIT $start, $pagesize";
...

				{
					...
					$query = "SELECT * FROM solicitud_despacho WHERE ".$whereA." ORDER BY" . " " . $sortfield . " ASC LIMIT $start, $pagesize";
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		...
		if($noaprobado == true && in_array(163,$_SESSION['permisos'])):			
		...
		$customers[] = array(
			...
			'acciones' => $export.$lista_materiales.'&nbsp;<a href="javascript: fn_mostrar_frm_modificar('.$row['id'].');"><img src="https://cdn1.iconfinder.com/data/icons/humano2/16x16/actions/old-edit-find.png" /></a>'.$aprobar_all.$eliminar
