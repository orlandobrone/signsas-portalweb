    ...
    $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Identificación', datafield: 'identificacion', filtertype: 'number', filtercondition: 'starts_with'},
                  { text: 'Beneficiario', datafield: 'beneficiario', filtertype: 'textbox', filtercondition: 'starts_with' },
                  { text: 'Num Cuenta', datafield: 'num_cuenta', filtertype: 'number',cellsalign: 'right'},
                  { text: 'Entidad', datafield: 'entidad', filtertype: 'textbox',  cellsalign: 'right' },
				  { text: 'Tipo Cuenta', datafield: 'tipo_cuenta', filtertype: 'checkedlist'}
                ]
            });
