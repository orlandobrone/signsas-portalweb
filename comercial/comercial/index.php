...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	define('URL_SECCION', URL_COMERCIAL);
	define('SECCION', COMERCIAL); ?>
                        ...
                        <tr>
                            ...
                            <td>
                            	<select name="criterio_ordenar_por" id="criterio_ordenar_por">
                                    <option value="comercial.id">Id</option>
                                	<option value="cliente.nombre">Cliente</option>
                                    <option value="usuario.nombres">Usuario</option>
                                    <option value="cotizacion.nombre">Cotizaci&oacute;n</option>
                                    <option value="comercial.otorgado">Otorgado</option>
                                </select>
                            </td>
                            <td> En</td>
                            <td>
